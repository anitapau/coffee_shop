...
curl -X POST -H "Content-Type: application/json" -d @./review_delete.json $ENDPOINT
#curl -X POST -H "Content-type: application/json" -d '{"name": "Michael", "reivew": "not good", "rating": -1}' $ENDPOINT
echo
